...
export const AGRONOMIC_RULES: ReadonlyArray<AgronomicRuleManifest> = Object.freeze([
  ...
  { ruleId: "K-ARROZ-CONTINUO-SOSBAI-2025", version: V_CROSSCHECK, crop: "ARROZ_IRRIGADO", subject: "K2O_ARROZ_CONTINUO", region: "RS/SC", status: "REQUIRES_AGRONOMIST_REVIEW", sourceSnapshotId: CROSSCHECK_SNAPSHOT_ID, sourceTitle: "Recomendações técnicas da pesquisa para o Sul do Brasil 2025", sourceInstitution: "SOSBAI", sourceYear: 2025, sourceLocator: "Tabela 4.7 p.48 e nota CTC", sourceUrl: SOSBAI_2025_URL },
  { ruleId: "S-ARROZ-SOSBAI-2025", version: V_CROSSCHECK, crop: "ARROZ_IRRIGADO", subject: "S", region: "RS/SC", status: "REQUIRES_AGRONOMIST_REVIEW", sourceSnapshotId: CROSSCHECK_SNAPSHOT_ID, sourceTitle: "Recomendações técnicas da pesquisa para o Sul do Brasil 2025", sourceInstitution: "SOSBAI", sourceYear: 2025, sourceLocator: "p.49", sourceUrl: SOSBAI_2025_URL },
  ...
  // Mo: Work encontrou conflito real entre CQFS 2016 e Embrapa Soja 2020; nenhum perfil é auto-selecionado.

...
/** ABÓBORA, ABOBRINHA e MORANGA -- capítulo 6.3.1 do Manual CQFS-RS/SC 2016. Bundle intencional (mesma tabela de dose), Grupo 2 pros dois nutrientes. Sem diagnose foliar. */
...
const NPK_CONTENT = `NITROGÊNIO -- por teor de matéria orgânica do solo: MO≤2,5%=180 kg N/ha. MO 2,6-5,0%=140. MO>5,0%=≤100. Aplicar 20kg N/ha no plantio (fonte orgânica preferencial).
Restante por espécie -- Abóbora e moranga: 5/10/15/20/25/25% aos 25/32/39/46/53/60 dias após o plantio. Abobrinha: 15/15/30/40% aos 15/30/45/60 dias.

FÓSFORO E POTÁSSIO -- dose por classe de disponibilidade no solo (Grupo 2 pros dois): Muito Baixo: P2O5=240, K2O=210 kg/ha. Baixo: 160/150. Médio: 120/120. Alto: 80/90. Muito Alto: ≤40/≤60. P2O5 todo no plantio.
K2O por espécie -- Abóbora e moranga: mesmo cronograma do N (5/10/15/20/25/25% aos 25-60 dias). Abobrinha: mesmo cronograma do N (15/15/30/40% aos 15-60 dias).
REGRA DE DISPENSA: se P e/ou K estiver 3x acima do teor crítico, não aplicar.`;

const SOURCE_TITLE_PREFIX = `${SOURCE_2016} — capítulo Hortaliças, ABÓBORA/ABOBRINHA/MORANGA (6.3.1)`;

async function main() {
  const cropProfileId = await ensureCropProfile("ABOBORA", "Abóbora, abobrinha e moranga", "HORTALICA");
  console.log(`ABOBORA: ${cropProfileId}`);

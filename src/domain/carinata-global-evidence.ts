...
export type CarinataTargetContext = {
  ...
  soilPH: number | null;
  soilPHMethod: "1_1_SOIL_WATER" | "OTHER" | "UNKNOWN";
  soilSamplingDepthToCm: number | null;
};
...
export const CARINATA_EVIDENCE_OBSERVATIONS: readonly CarinataEvidenceObservation[] = Object.freeze([
  {
    ...
    sourceLocator: "Agronomy Journal 111:1304–1311; DOI 10.2134/agronj2018.06.0419",
  ...
  },
  {
    ...
    sourceLocator: "Agronomy Journal; DOI 10.2134/agronj2018.10.0678",
  ...
  },
  {
    ...
    sourceLocator: "Agronomy Journal 113:1945–1960; DOI 10.1002/agj2.20501",
  ...
  },
  {
    ...
    sourceLocator: "GCB Bioenergy 13:1275–1289; Table 2; DOI 10.1111/gcbb.12846",
    context: "Cinco site-years em Florida/Georgia; não irrigado; loamy sand, sandy loam e sandy clay loam; solo amostrado até 15 cm; pH 1:1 solo:água entre 5,8 e 6,4; N 0–179 kg/ha.",
  ...
  },
  {
    ...
    sourceLocator: "Crop Science 63:833–851; DOI 10.1002/csc2.20900",
  ...
  },
  {
    ...
    sourceLocator: "UF/IFAS publication SS-AGR-384/AG389; seção Nutrient Management",
    ...
    observation: "Indica bom desenvolvimento em solos bem drenados com pH 5,5–6,5; apresenta manejo de N/S parcelado e critérios de risco para B em solos grosseiros/arenosos com pH >7 ou seca prolongada. A página consultada não expõe data de publicação inequívoca, portanto o ano permanece nulo. Essas recomendações não são automaticamente transferidas para RS/SC.",
    quantitativePrescriptionAllowed: false,
  },
]);
...
const COASTAL_PLAIN_N_PROFILE = {
  ...
  constraints: {
    ...
    soilPH: { kind: "NUMERIC_RANGE" as const, min: 5.8, max: 6.4, unit: "pH 1:1 soil:water" },
    soilPHMethod: { kind: "CATEGORICAL" as const, allowed: ["1_1_SOIL_WATER"] },
    soilSamplingDepthToCm: { kind: "NUMERIC_RANGE" as const, min: 15, max: 15, unit: "cm" },
  },
  criticalDimensions: [
    "crop",
    "waterRegime",
 ...
 * e a profundidade são os reportados pela fonte, não faixas inventadas.

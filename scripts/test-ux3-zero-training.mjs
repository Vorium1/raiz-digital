...
assert.match(simpleReview, /needsManagementContext/);
assert.match(simpleReview, /Defina o manejo antes de emitir/);
assert.match(simpleReview, /a RAIZ não publica presumindo um sistema/);
assert.match(officialResultRoute, /normalizeManagementSystem/);
assert.match(officialResultRoute, /OFFICIAL_RESULT_MANAGEMENT_CONTEXT_REQUIRED/);
...
assert.match(simpleRecommendationContext, /Concluir decisão de calagem/);
assert.match(simpleRecommendationContext, /não assume preparo convencional nem estágio do plantio direto/);

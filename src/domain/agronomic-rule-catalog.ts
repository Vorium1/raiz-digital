...
export const AGRONOMIC_RULES: ReadonlyArray<AgronomicRuleManifest> = Object.freeze([
  ...
  { ruleId: "LIMING-SOYBEAN-RS-SC-2025-NO-TILL-CONSOLIDATED", version: V_CROSSCHECK, crop: "SOJA", subject: "CALAGEM_SPD_CONSOLIDADO", region: "RS/SC", status: "REQUIRES_AGRONOMIST_REVIEW", sourceSnapshotId: CROSSCHECK_SNAPSHOT_ID, sourceTitle: "Indicações técnicas para a cultura da soja no Rio Grande do Sul e em Santa Catarina, safras 2025/2026 e 2026/2027", sourceInstitution: "44ª Reunião de Pesquisa de Soja da Região Sul / Embrapa Trigo / UPF", sourceYear: 2025, sourceLocator: "Tabela 2.2 p.24 versus seção 2.3.3 pp.26-27: conflito 1/2 vs 1/4 SMP e Al>=10% vs Al>=30%", sourceUrl: SOJA_RS_SC_2025_URL },

...
assert.match(workflow, /pr\?\.base\?\.ref === "develop"/, "PR candidato deve apontar para develop");
...
console.log("homologation-candidate-guard: SHA explícito, PR aberto same-repo/develop, ordem antes de secrets e checkout exato aprovados");

...
export default function PlatformError({ reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return (
    <div className="simple-platform-state is-error" role="alert">
      <span className="simple-platform-state-icon"><Icon name="alert" size={22}/></span>
      ...
      <button type="button" onClick={reset}><Icon name="refresh" size={14}/> Tentar novamente</button>
    </div>
  );
}

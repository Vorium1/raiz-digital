  ...
  return <div className="wizard-shell">
    ...
    <section className="card wizard-card">
      ...
      {step === 2 && <div className="form-section">
        <div className="form-heading"><span className="eyebrow">RESULTADOS</span><h2>Importe o laudo do laboratório.</h2><p>CSV é lido e validado no servidor. No modo real, o mesmo conteúdo é revalidado no commit antes de entrar no PostgreSQL.</p></div>

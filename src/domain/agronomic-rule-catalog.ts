...
export const AGRONOMIC_RULES: ReadonlyArray<AgronomicRuleManifest> = Object.freeze([
  ...
  { ruleId: "LIMING-SOYBEAN-RS-SC-2025-CONVENTIONAL", version: V_CROSSCHECK, crop: "SOJA", subject: "CALAGEM_CONVENCIONAL", region: "RS/SC", status: "READY_FOR_IMPLEMENTATION", sourceSnapshotId: CROSSCHECK_SNAPSHOT_ID, sourceTitle: "Indicações técnicas para a cultura da soja no Rio Grande do Sul e em Santa Catarina, safras 2025/2026 e 2026/2027", sourceInstitution: "44ª Reunião de Pesquisa de Soja da Região Sul / Embrapa Trigo / UPF", sourceYear: 2025, sourceLocator: "item 2.3, Tabelas 2.2-2.3, pp.24-26; runtime falha fechado nos quadrantes V/Al não inequívocos", sourceUrl: SOJA_RS_SC_2025_URL },
  { ruleId: "LIMING-SOYBEAN-RS-SC-2025-NO-TILL-ESTABLISHMENT", version: V_CROSSCHECK, crop: "SOJA", subject: "CALAGEM_IMPLANTACAO_SPD", region: "RS/SC", status: "READY_FOR_IMPLEMENTATION", sourceSnapshotId: CROSSCHECK_SNAPSHOT_ID, sourceTitle: "Indicações técnicas para a cultura da soja no Rio Grande do Sul e em Santa Catarina, safras 2025/2026 e 2026/2027", sourceInstitution: "44ª Reunião de Pesquisa de Soja da Região Sul / Embrapa Trigo / UPF", sourceYear: 2025, sourceLocator: "item 2.3, Tabelas 2.2-2.3, pp.24-26: pHágua<5,5, 1 SMP para pH 6,0, incorporado", sourceUrl: SOJA_RS_SC_2025_URL },
  { ruleId: "LIMING-SOYBEAN-RS-SC-2025-NO-TILL-CONSOLIDATED", version: V_CROSSCHECK, crop: "SOJA", subject: "CALAGEM_SPD_CONSOLIDADO", region: "RS/SC", status: "READY_FOR_IMPLEMENTATION", sourceSnapshotId: CROSSCHECK_SNAPSHOT_ID, sourceTitle: "Indicações técnicas para a cultura da soja no Rio Grande do Sul e em Santa Catarina, safras 2025/2026 e 2026/2027", sourceInstitution: "44ª Reunião de Pesquisa de Soja da Região Sul / Embrapa Trigo / UPF", sourceYear: 2025, sourceLocator: "item 2.3, Tabela 2.2 p.24: sem restrições 10-20 cm = 1/2 SMP pH 6,0 superficial (máx. 5 t/ha PRNT100); com restrições = pH<5,5 e Al>=10%, SMP médio 0-10/10-20, incorporação condicionada à avaliação profissional", sourceUrl: SOJA_RS_SC_2025_URL },
  ...
  { ruleId: "CALAGEM-ARROZ-SECO-SOSBAI-2025", version: V_CROSSCHECK, crop: "ARROZ_IRRIGADO", subject: "CALAGEM_SOLO_SECO", region: "RS/SC", status: "READY_FOR_IMPLEMENTATION", sourceSnapshotId: CROSSCHECK_SNAPSHOT_ID, sourceTitle: "Recomendações técnicas da pesquisa para o Sul do Brasil 2025", sourceInstitution: "SOSBAI", sourceYear: 2025, sourceLocator: "pp.42-43, Tabelas 4.1-4.2: domínio positivo pH<5,5 + V<65% + Al>=10%; não aplicar em V>=65% + Al<10%; quadrantes mistos, contexto de rotação e seleção de método falham fechado no runtime", sourceUrl: SOSBAI_2025_URL },
